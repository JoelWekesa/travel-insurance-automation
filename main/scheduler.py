...
def run_test():
    ...
    try:
        ...
        logger.error(f"[X] Test failed: {str(e)}")
...
def main():
    ...
    logger.info(f"Tests will run 4 times per day (every 6 hours)")
    ...
    schedule.every(6).hours.do(run_test)
    
    logger.info("Scheduler initialized - Next run in 6 hours")
    logger.info("=" * 80)
    logger.info("")
